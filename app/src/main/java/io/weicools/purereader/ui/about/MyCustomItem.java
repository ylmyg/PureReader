...
public class MyCustomItem extends MaterialAboutItem {
  ...
  public static class MyCustomItemViewHolder extends MaterialAboutItemViewHolder implements View.OnClickListener {
    ...
    MyCustomItemViewHolder(View view) {
      super(view);
      this.view = view;
      icon = (ImageView) view.findViewById(com.danielstone.materialaboutlibrary.R.id.mal_item_image);
      text = (TextView) view.findViewById(com.danielstone.materialaboutlibrary.R.id.mal_item_text);
      subText = (TextView) view.findViewById(com.danielstone.materialaboutlibrary.R.id.mal_action_item_subtext);
  ...
  public static void setupItem(MyCustomItemViewHolder holder, MyCustomItem item, Context context) {
    ...
    if (item.getOnClickListener() != null) {
      ...
      context.getTheme().resolveAttribute(com.danielstone.materialaboutlibrary.R.attr.selectableItemBackground, outValue, true);
      ...
      TypedValue outValue = new TypedValue();
      context.getTheme().resolveAttribute(com.danielstone.materialaboutlibrary.R.attr.selectableItemBackground, outValue, false);
      holder.view.setBackgroundResource(outValue.resourceId);
