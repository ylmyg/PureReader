...
public class AboutActivity extends MaterialAboutActivity {
  ...
  protected MaterialAboutList getMaterialAboutList (@NonNull final Context c) {
    MaterialAboutCard.Builder appCardBuilder = new MaterialAboutCard.Builder().addItem(
        new MaterialAboutTitleItem.Builder().text("Pure Reader")
            .desc("© 2018 Weicools")
        ...
        .addItem(new MaterialAboutActionItem.Builder().text("Changelog")
            ...
            .setOnClickAction(ConvenienceBuilder.createWebViewDialogOnClickAction(c, "Releases",
                "https://github.com/lecymeng/PureReader/releases", true, false))
            .build())
        .addItem(ConvenienceBuilder.createRateActionItem(c, ContextCompat.getDrawable(c, R.drawable.ic_star_filled),
            "Rate this app", null));

    MaterialAboutCard.Builder authorCardBuilder = new MaterialAboutCard.Builder().title("Author")
        .addItem(new MaterialAboutActionItem.Builder().text("Weicools")
            .subText("China Beijing")
            .icon(R.drawable.ic_profile)
            .build())
        .addItem(ConvenienceBuilder.createWebsiteActionItem(c, ContextCompat.getDrawable(c, R.drawable.ic_brower),
            "Visit Website", true, Uri.parse("https://weicools.com")))
        .addItem(
            ConvenienceBuilder.createEmailItem(c, ContextCompat.getDrawable(c, R.drawable.ic_email), "Send an email",
                true, "lecymeng@outlook.com", "Question concerning MaterialAboutLibrary"))
        .addItem(new MaterialAboutActionItem.Builder().text("Fork on GitHub")
            .icon(R.drawable.ic_github)
            .setOnClickAction(
                ConvenienceBuilder.createWebsiteOnClickAction(c, Uri.parse("https://github.com/lecymeng")))
            .build());

    MaterialAboutCard.Builder libraryCardBuilder = new MaterialAboutCard.Builder().title("Open Source Library")
        .addItem(ConvenienceBuilder.createWebsiteActionItem(c, ContextCompat.getDrawable(c, R.drawable.ic_library_3),
            "RxJava2", true, Uri.parse("https://github.com/ReactiveX/RxJava")))
        .addItem(ConvenienceBuilder.createWebsiteActionItem(c, ContextCompat.getDrawable(c, R.drawable.ic_library_2),
            "Retrofit", true, Uri.parse("https://github.com/square/retrofit")))
        .addItem(ConvenienceBuilder.createWebsiteActionItem(c, ContextCompat.getDrawable(c, R.drawable.ic_library_1),
